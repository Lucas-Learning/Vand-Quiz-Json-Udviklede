...
namespace Vand_Quiz_Json
{
    ...
    {
        static List<Quizzen> Convert_json_to_cs_Sql()
        {
            
                string fileName = @"C:\Users\lp\Downloads\Vand-Quiz-Json-master\Vand-Quiz-Json-master\Vand Quiz Json\Spørgsmål3.json";
        ...
        public void SqlQuizzen()
        {
            List<Quizzen> quizlist = Convert_json_to_cs_Sql();
            if (quizlist == null)
            {
